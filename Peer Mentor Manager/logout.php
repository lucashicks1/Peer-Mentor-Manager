...
<head>
    ...
    <title>Terrace Mentor Manager - Log Out</title>
    <!-- Bootstrap css-->
...
<body>
    ...
    <h1 class="text-center heading my-4">Log Out</h1>
    <p class="lead my-4 text-center red">You have been logged out</p>
    <a href="login.php">
        <p class="lead my-4 text-center">Login Here</p>
    </a>
